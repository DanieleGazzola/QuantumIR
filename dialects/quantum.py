...
# QubitTypeF64: TypeAlias = ComplexType[Float64Type]
...
#     _attributes = [IntegerAttr(name="state", value=0)] # default to 0
#     _results = [OpResult(IntegerType(1))]

#     def __init__(self, qubit: SSAValue, state: int):
#         super().__init__(
#             operands=[qubit],
...
#     def __init__(self, qubit: SSAValue):
#         super().__init__(
#             operands=[qubit],
#             results=[IntegerType(1)]
#         )
...
#     def __init__(self, control_1: SSAValue,  control_2: SSAValue, target: SSAValue):
#         super().__init__(
#             operands=[control_1, control_2, target],
#             results=[IntegerType(1)]
#         )

# class MeasurementOp(IRDLOperation):
#     name = "q.measure"

#     _operands = [Operand(IntegerType(1))]
#     _results = [OpResult(IntegerType(1))] # result of the measurement
